...
const Recipient: React.FC<TablePageProps> = () => {
    ...
    const [tagLists, setTagLists] = useState<tagState[]>([]);
                ...
                .then((result) => {
                    if (result && result.request.status === 200) {
                        if (result.data.data.length === 0) {
                            ...
                            let filterResult = result.data.data.map((item: RecipientProp) => item.tag);
                            setTagLists(filterResult);
                ...
                <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
                    ...
                    <div className="max-w-full overflow-x-auto">
                        ...
                        <RecipientView
                            ...
                            RecipientViewState={RecipientViewState}
                            setRecipientViewState={setRecipientViewState}
